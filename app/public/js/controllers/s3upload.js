    ...
    window.S3Upload = (function() {
        ...
        function S3Upload(options) {
            ...
            if (this.dom_element) {
                ...
                this.handleFileSelect(this.dom_element);
        ...
        S3Upload.prototype.executeOnSignedUrl = function(file, callback, opts) {
            ...
            var prefix = generateRoomIdentifier();

            xhr.open('GET', this.s3_sign_put_url + '?s3_object_type=' + type + '&s3_object_name=' + encodeURIComponent(prefix), true);
